(function () {
    ...
    function loadConfig() {
        const saved = localStorage.getItem('cardioTimerConfig');
        if (saved) {
            try {
    ...
    function saveConfig() {
        ...
        localStorage.setItem('cardioTimerConfig', JSON.stringify(configToSave));
    }
    ...
    function createFloatingParticles() {
        const particlesContainer = document.getElementById('cardio-particles');
    ...
    function animateCompletion() {
        ...
        anime({
            targets: '#cardio-completionCard i',
            rotate: [0, 360],
            scale: [0, 1.2, 1],
            duration: 1000,
            delay: 200,
    ...
    function animatePageLoad() {
        anime({
            targets: '#cardio-view .header-card',
            translateY: [-50, 0],
            opacity: [0, 1],
            duration: 800,
            easing: 'easeOutQuad'
        ...
        anime({
            targets: '#cardio-view .exercise-card',
            scale: [0.8, 1],
            opacity: [0, 1],
            duration: 1000,
            delay: 200,
        ...
        anime({
            targets: '#cardio-view .circular-timer',
            scale: [0, 1],
            opacity: [0, 1],
            duration: 1000,
            delay: 300,
        ...
        anime({
            targets: '#cardio-view .exercise-visual-card',
            scale: [0, 1],
            opacity: [0, 1],
            duration: 1000,
            delay: 250,
        ...
        anime({
            targets: '#cardio-view .round-info-card',
            translateX: [-100, 0],
            opacity: [0, 1],
            duration: 800,
            delay: 400,
        ...
        anime({
            targets: '#cardio-view .btn-lg-custom',
            scale: [0, 1],
            opacity: [0, 1],
            duration: 600,
    ...
    // Elementos DOM
    const elements = {
        soundBtn: document.getElementById('cardio-soundBtn'),
        soundIcon: document.getElementById('cardio-soundIcon'),
        settingsBtn: document.getElementById('cardio-settingsBtn'),
        settingsPanel: document.getElementById('cardio-settingsPanel'),
        totalMinutesDisplay: document.getElementById('cardio-totalMinutesDisplay'),
        cyclesEstimate: document.getElementById('cardio-cyclesEstimate'),
        decreaseTotal: document.getElementById('cardio-decreaseTotal'),
        increaseTotal: document.getElementById('cardio-increaseTotal'),
        sentadillasTime: document.getElementById('cardio-sentadillasTime'),
        cardioTime: document.getElementById('cardio-cardioTime'),
        descanso1Time: document.getElementById('cardio-descanso1Time'),
        descanso2Time: document.getElementById('cardio-descanso2Time'),
        preparacionTime: document.getElementById('cardio-preparacionTime'),
        roundsNumber: document.getElementById('cardio-roundsNumber'),
        roundInfo: document.getElementById('cardio-roundInfo'),
        exerciseCard: document.getElementById('cardio-exerciseCard'),
        exerciseIcon: document.getElementById('cardio-exerciseIcon'),
        exerciseName: document.getElementById('cardio-exerciseName'),
        exerciseTimer: document.getElementById('cardio-exerciseTimer'),
        exerciseGif: document.getElementById('cardio-exerciseGif'),
        warningText: document.getElementById('cardio-warningText'),
        prepText: document.getElementById('cardio-prepText'),
        progressCircle: document.getElementById('cardio-progressCircle'),
        totalTimer: document.getElementById('cardio-totalTimer'),
        resetBtn: document.getElementById('cardio-resetBtn'),
        startBtn: document.getElementById('cardio-startBtn'),
        completionCard: document.getElementById('cardio-completionCard'),
        completionStats: document.getElementById('cardio-completionStats'),
        instructionsText: document.getElementById('cardio-instructionsText')
    };
