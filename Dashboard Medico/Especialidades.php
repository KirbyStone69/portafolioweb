  ...
  <div class="main-container d-flex">
        <div class="sidebar bg-primary" id="side_nav">
            ...
            <ul class="list-unstyled px-2">
                ...
                <li class="active"><a href="Especialidades.php" class="text-decoration-none px-3 py-2 d-block">
  ...
  <div class="row g-3 align-items-stretch">
    <div class="col-12 col-lg-4">
      <div class="card border-1 shadow-sm h-100">
        <div class="card-body">
          <h5 class="mb-3">Crear nueva especialidad</h5>
            <form action="php/Especialidades/insertar.php" method="post">
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control" rows="4" placeholder="Descripción" name="descripcion" required></textarea>
              </div>
        ...
        <div class="card-body">
          ...
          <div class="card border-1 mb-2">
            <div class="card-body d-flex justify-content-between align-items-center py-2">
              <span class="small text-muted">Total de especialidades</span>
              <span class="fw-semibold" id="total-especialidades">0</span>
            </div>
          </div>
        </div>
      </div>
...
<section class="container py-3">
      ...
      <div class="table-responsive">
        <table class="table align-middle">
          ...
          <tbody id="tabla-especialidades">
            ...
            <tr>
              <td class="fw-semibold">Cardiología</td>
              <td>Diagnóstico y tratamiento de enfermedades del corazón y sistema cardiovascular</td>
              <td class="text-end">
  ...
  (function() {
    ...
    if (ok === '0') {
      ...
      Swal.fire({
        icon: 'success',
        title: 'Registrado',
        text: 'La especialidad se registró correctamente',
        timer: 2000,
  ...
  <!--obtiene los datos de listar.php y las plazma en la tabla-especialidades-->
  <script src="js/especialidades/tabla.js"></script>
