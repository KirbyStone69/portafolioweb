...
if ($contrasena !== $contrasena_confirmar) {
    header("Location: /Dashboard Medico Static/registro.php?error=1");
    exit;
}
...
if ($resultado_verificar->num_rows > 0) {
    ...
    header("Location: /Dashboard Medico Static/registro.php?error=2");
    $sql_verificar->close();
    $conexion->close();
    exit;
}
...
try {
    ...
    header("Location: /Dashboard Medico Static/registro.php?ok=1");
    ...
    $conexion->rollback();
    header("Location: /Dashboard Medico Static/registro.php?error=3");
    $conexion->close();
    exit;
}
?>
