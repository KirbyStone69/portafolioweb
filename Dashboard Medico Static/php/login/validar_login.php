...
if ($resultado->num_rows === 1) {
    ...
    if ($datos_usuario['Activo'] == 1) {
        ...
        if ($datos_usuario['Rol'] === 'Paciente') {
            ...
            header("Location: /Dashboard Medico Static/agenda.php");
        } else {
            // el resto del staff va al dashboard
            header("Location: /Dashboard Medico Static/Dashboard.php");
        }
        exit;
    } else {
        // usuario inactivo
        header("Location: /Dashboard Medico Static/index.php?error=1");
        exit;
    }
} else {
